...
This does **not** yet make every authority boundary final. `sync`, `acquire`, export-only Markdown projection, generated Markdown backup/review policy, and file-back cutover still need migration work.
