...
| [wiki-forest-markdown-import-dogfood-2026-06-25](entities/wiki-forest-markdown-import-dogfood-2026-06-25.md) | llm-wiki `wikis.yaml` 全 entries を temp store に `import --markdown --markdown-exclude-dir raw` した forest dogfood。37/42 projects は import 成功し、次 blocker は performance ではなく duplicate title / alias collision。diagnostics / source role / artifact role / schema v6 `page_handles` / `read` ambiguity は実装済み、残りは Markdown import softening と ambiguous edge resolution |
