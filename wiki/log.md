...
## [2026-06-28 22:20] file-back | [[ai-author-feedback-2026-06-26]] §Updates に verification discipline を追記（postwrite-green ≠ SSoT 着地）
隔離 worktree の file-back は throwaway store + 未マージ branch なので postwrite green でも共有 SSoT(origin/main) 未着地が起こる。done 判定に merge-to-main + read-back(grasp read/backlinks で text+edge 確認)を含める。worktree-per-agent 既定化で必須。
