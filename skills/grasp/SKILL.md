...
- `1.8.36` 以降、`revert-plan --scope content-subjects` は選ばれた page event を戻すために必要な後続 same-page dependents も `dependent_event_ids` として候補に足し、read-only plan がそのまま `revert-events` へ渡せるかを検査する。
